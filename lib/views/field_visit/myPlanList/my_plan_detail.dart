                              ...
                              child: Padding(
                                ...
                                child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      //String startDate = formattedStartDate.(0,15);


                                      //String formattedStartDate = DateFormat('MM/dd/yyyy').format(item.tourDate);
                                      String date = formattedStartDate.substring(0, formattedStartDate.length - 8);
