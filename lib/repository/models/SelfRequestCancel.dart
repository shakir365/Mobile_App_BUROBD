class SelfRequestCancel  {
 late bool _success;
  late String _messageEn;
  late String _messageBn;
  Null _data;

  SelfRequestCancel ({required bool success, required String messageEn, required String messageBn, Null data}) {
  ...
  SelfRequestCancel .fromJson(Map<String, dynamic> json) {
